                    ...
                    <div class="container px-4 px-lg-5">
                        ...
                        <div class="row gx-4 gx-lg-5 align-items-center my-5">
                            ...
                            <div class="col-lg-5">
                                ...
                                <h4> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                                    Enter the new  <?php echo $toUpdate ?>:</h4>

                                <form action = "update-confirmed.php" method = "post">
                                    <input type="text" placeholder="Enter <?php echo $toUpdate ?>..." name="new_value" required><br>
                                    <input type = "hidden" name = "column" value = "<?php echo $toUpdate?>">
