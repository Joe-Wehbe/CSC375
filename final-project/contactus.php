...
<html lang="en">
	...
	<body>
		...
		<h5 style="text-align:center"> You can contact us via: </h5>

		<ul style="text-align:center">
			<h8> Phone: 12345678 </h8> <br>
			<h8> Email: joe.wehbe@lau.edu </h8>			    
        </ul> <br>

        <h5 style="text-align:center"> Social Media: </h5>
        <ul style="text-align:center"> 
			<h8> Facebook: @cinema_movies </h8> <br>
			<h8> Instagram: @cinemaMovies </h8>	<br>	
            <h8> Twitter: @cinemamovies </h8> <br>
		</ul>
