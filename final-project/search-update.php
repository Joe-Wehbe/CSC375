...
<html lang="en">
    ...
    <body>
        ...
        <h4>
            ...
            <form action = "search-update.php" method="post" style = "text-align:center">
                ...
                <div class="container">                   
                    <div class="centered"> <br>
                        ...
                        <?php
                            ...
                            $name = $_POST['search'];
                            $query = $mysqli->prepare("SELECT * FROM movies where name like '%$name%';");
                            $query->execute();
                            ...
                            <div class="row gx-2 gx-lg-1">							
                                ...
                                ?> 
                                    <div class="col-md-3 mb-0">						
                                        <a href = "updateMovie.php?idMovie= <?php echo $movies["id"] ?>" style = "text-decoration:none; color:black">                           
                                            <div class="card-body">
