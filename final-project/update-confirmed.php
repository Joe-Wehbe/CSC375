    ...
    <body>
        ...
        <?php
            ...
            if(isset($_POST['submit'])){
                ...
                $query = $mysqli-> prepare("UPDATE movies SET $column = '$newValue' WHERE id = $idMovie;");
                $query->execute();
        ...
        ?> 
            ...
            <div class="container px-4 px-lg-5">
                ...
                <h1 style = "text-align: center"> This movie has been updated<br>
