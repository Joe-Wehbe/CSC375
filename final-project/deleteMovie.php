                    ...
                    <div class="container px-4 px-lg-5">
                        ...
                        <div class="row gx-4 gx-lg-5 align-items-center my-5">
                            ...
                            <div class="col-lg-5">
                                ...
                                <h4> Are you sure you want to delete this movie? </h4><br>
                                <h2>                                  
                                    <a href = "delete-code.php?MovieId=<?php echo $info["id"]?>" style = "text-decoration:none; color:black">
                                        <button type="button" style = "text-decoration:none; color:white; background-color: #333333; border-radius: 5px; height: 60px; width: 200px">Delete</button>
                                    </a>
                                       
                                    <a href = "delete.php">
                                        <button type="button" style = "text-decoration:none; color:white; background-color: #333333; border-radius: 5px; height: 60px; width: 200px">Cancel</button>
                                    <a>
                                </h2>
                            </div>                             
                        </div>
