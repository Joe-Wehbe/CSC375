    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container px-5">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="navbar-brand"><a class="nav-link active" href="!#">Coming Soon</a></li>
        ...
        <div class="container px-4 px-lg-5">
            ...
            <form method="post" action = "search-comingS.php" style = "text-align:center" > <br>
                <input type="text" name="search" placeholder="Search movie/director/actor/genre..." style = "width: 600px; height: 75px; text-align:center">            
		    ...
		    $query = $mysqli->prepare("SELECT * FROM movies where release_date > (SELECT CURDATE() AS Today);");
		    $query->execute();
